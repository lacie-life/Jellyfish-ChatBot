...
if __name__ == "__main__":
    ...
    models = [
        {
            "model_type": "rbert",
            "model_dir": "./models/original_train_dev/phobert_rbert_base_maxlen_384_epochs_10_6"
        },
        {
            "model_type": "bert_em_es",
            "model_dir": "./models/original_train_dev/phobert_em_es_base_maxlen_384_epochs_10_6"
        },
    ]
    weights = [0.4, 0.6]
