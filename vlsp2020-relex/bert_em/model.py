...
class BertEntityStarts(BertPreTrainedModel):
    
    def __init__(self, config):
        super(BertEntityStarts, self).__init__(config)
...
class BertConcatAll(BertPreTrainedModel):
    
    def __init__(self, config):
        super(BertConcatAll, self).__init__(config)
        self.num_labels = config.num_labels
