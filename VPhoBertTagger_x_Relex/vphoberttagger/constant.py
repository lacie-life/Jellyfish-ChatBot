...
LABEL2ID_LVTN = ['O', 'B-Price', 'I-Price', 'B-Location', 'I-Location', 'B-Product', 'I-Product', 'B-Promotion', 'I-Promotion',
                 'B-Regulation', 'I-Regulation', 'B-Time', 'I-Time', 'B-Organization', 'I-Organization']

PROCESSOR_MAPPING = {
    'vinai/phobert-base-v2': convert_word_segment_examples_features,
...
LABEL_MAPPING = {
    ...
    'lvtn': {
        'label2id': LABEL2ID_LVTN,
        'id2label': {idx: label for idx, label in enumerate(LABEL2ID_LVTN)},
        'header': ['token', 'ner']
    }
}